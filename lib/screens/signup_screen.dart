            ...
            child: Column(
              ...
              children: [
                ...
                Center(
                  child: Column(
                    children: [
                      Icon(Icons.car_rental, size: 80, color: Theme.of(context).primaryColor),
                      const SizedBox(height: 16),
                      const Text('Create Account', style: TextStyle(fontSize: 28, fontWeight: FontWeight.bold)),
                      const SizedBox(height: 8),
                      Text('Sign up to get started with RozRides', style: TextStyle(fontSize: 14, color: Colors.grey.shade600)),
                    ],
                  ),
                ),
